...
?>
    ...
    ?>
      ...
      ?>
        <div class="grid-item item-m-4">
          ...
          <h3 class="font-din"><?php echo $teammate_name; ?></h3>
    ...
    ?>
      <section>
        <div class="grid-item item-m-4">
          <h2 class="font-din">Colaboradores</h2>
          <ul>
      ...
      ?>
            <li>
              ...
              <h3 class="font-din"><?php echo $collaborator_name; ?></h3>
    ...
    ?>
      <section class="grid-row">
        <div class="grid-item item-m-4">
          <h2 class="font-din">Servicios</h2>
        </div>
        <div class="grid-item item-m-8">
          <ul>
      ...
      ?>
            <li>
              <h3 class="font-din"><?php echo $service_name; ?></h3>
