...
?>
      <section class="grid-row">
        <div class="grid-item item-m-4">
          <h2 class="font-heading font-uppercase font-size-heading">About</h2>
        </div>
    ...
    ?>
      ...
      ?>
        <div class="grid-item item-m-4">
          ...
          <h3 class="font-heading font-uppercase font-size-heading"><?php echo $teammate_name; ?></h3>
    ...
    ?>
      <section>
        <div class="grid-item item-m-4">
          <h2 class="font-heading font-uppercase font-size-heading">Colaboradores</h2>
          <ul>
      ...
      ?>
            <li>
              ...
              <h3 class="font-heading font-size-heading-small"><?php echo $collaborator_name; ?></h3>
    ...
    ?>
      <section class="grid-row">
        <div class="grid-item item-m-4">
          <h2 class="font-heading font-uppercase font-size-heading">Clientes</h2>
        </div>
        <div class="grid-item item-m-8">
          <ul>
    ...
    ?>
      <section class="grid-row">
        <div class="grid-item item-m-4">
          <h2 class="font-heading font-uppercase font-size-heading">Servicios</h2>
        </div>
        <div class="grid-item item-m-8">
          <ul>
      ...
      ?>
            <li>
              <h3 class="font-heading font-uppercase font-size-heading-small"><?php echo $service_name; ?></h3>
    ...
    ?>
      <section class="grid-row">
        <div class="grid-item item-m-12">
          <h2 class="font-heading font-uppercase font-size-heading">Contacto</h2>
        <?php
